...
/*
    Script: BattleLogic
    Author: Gareth Lockett (Based on supplied)
    Version: 1.0
...
// TODO: Randomly select a hero and monster from the active heroes ( eg choosing one hero and one monster per round )
        ...
        /* TODO: Write code below to decide the outcome of the fighting hero and monster characters in an interesting way.
            ...
            NOTES:
                - Make sure to call the DoDamage( damageAmount ) method on whichever character(s) is receiving damage ( *See CharacterStats.cs )
    ...
    {
        /*
            Method: private void SetAllActiveCharacterColors( Color color )
            Description: Handy method to easily modify all the active hero and active monster sprite colors at once.
        */
    ...
    {
        /*
            Method: private void EndBattle( string finalMessage )
            Description: Method to call once the battle has ended.
        */

        // Reset any remaining character colors back to white.
        this.SetAllActiveCharacterColors( Color.white );

        // Stop the Fight() method from been called.
        this.CancelInvoke();
